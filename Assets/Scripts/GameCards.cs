...
public class GameCards : MonoBehaviour
{
    ...
    public void GenerateCards()
    {
        ...
        mobsCards.Add(new Monster("Отчёт", "Долбанные бумаги! Что? Это только за неделю?", 0, Monster.Type.CodeTroubles));
        ...
        mobsCards.Add(new Monster("Переобучение ии", "“Правильно” не всегда значит “хорошо”", 0, Monster.Type.CodeTroubles));
        mobsCards.Add(new Monster("А что если так попробовать ?",
            "Похоже на начало истории об отличном стартапе. Или на начало очень плохой идеи", 0, Monster.Type.CodeTroubles));
        ...
        mobsCards.Add(new Monster("Переизбыток ctrl+c кода", "Жаль, что с деньгами так не выйдет...", 0, Monster.Type.CodeTroubles));
        mobsCards.Add(new Monster("Неоднозначное тз", "Хочу то, сам не знаю чего, но чтобы принесли завтра!", 0, Monster.Type.CodeTroubles));
        ...
        mobsCards.Add(new Monster("Токсичный тиммейт", "Действительно злой и неприятный", 0, Monster.Type.SocialTroubles));
        mobsCards.Add(new Monster("Тиммейт - тормоз", "Делает быстро всего одну вещь — уходит.", 0, Monster.Type.SocialTroubles));
        ...
        mobsCards.Add(new Monster("Расистские шуточки", "Негр и мексиканец падают с небоскрёба.Кто упадёт", 0, Monster.Type.SocialTroubles));
        mobsCards.Add(new Monster("Всеобщая прострация", "С этим надо бы что - то сделать, но как - то все равно...", 0, Monster.Type.SocialTroubles));
        mobsCards.Add(new Monster("Не сходящаяся бухгалтерия", "Не математики считают, что математики считают", 0, Monster.Type.SocialTroubles));
        ...
        mobsCards.Add(new Monster("Хейтеры", "Как думаете, они ненавидят всех или только вас?", 0, Monster.Type.OutsideTroubles));
        mobsCards.Add(new Monster("Противники насилия", "Это они еще Доку 2 не видели...", 0, Monster.Type.OutsideTroubles));
        mobsCards.Add(new Monster("Проблемы с авторскими правами",
            "Экономить на композиторе и просто вставлять треки Audiomachine было не лучшей идеей", 0, Monster.Type.OutsideTroubles));
        mobsCards.Add(new Monster("Феминистки", "Вообще не понятно, откуда они тут", 0, Monster.Type.OutsideTroubles));
        mobsCards.Add(new Monster("Проблемы с балансом", "Даже в тетрисе были квадратные блоки", 0, Monster.Type.OutsideTroubles));
        mobsCards.Add(new Monster("Нулевая реиграбельность", "Когда была всего одна задача и всё равно не справились", 0, Monster.Type.OutsideTroubles));
